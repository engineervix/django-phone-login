...
class PhoneBackend(ModelBackend):
    ...
    def get_phone_number_data(self, phone_number):
        ...
        data = {phone_number_field: phone_number}
        return data
    ...
    def authenticate(self, request, pk=None, otp=None, **extra_fields):
        ...
        try:
            ...
            phone_token = PhoneToken.objects.get(pk=pk, otp=otp, used=False, timestamp__gte=timestamp_difference)
        ...
        user = self.user_model.objects.filter(**self.get_phone_number_data(phone_token.phone_number)).first()
